...
export get_trop_A_disc,
get_polytope_from_cycle,
compute_A_discriminant,
get_dual_fan_of_chow_polytope,
get_tropical_cycle,
get_vandermonde_matrix,
sample,
get_chow_fan
...
end #module TropicalImplicitization
